...
<head>
  ...
  <title>Login E-Pelanggaran SMAN 1 Magetan</title>
...
<?php ?>
<body class="hold-transition login-page" style="background:url(theme/dist/img/smasamagetan.jpg)
no-repeat center center fixed; background-size: cover;
 -webkit-background-size: cover; 
 -moz-background-size: cover; -o-background-size: cover;"><div class="login-box">
  <div class="login-logo">
    <h2><b>E-PELANGGARAN</b><br><b>SMA NEGERI 1 MAGETAN</b></h2></a>
  </div>
  <!-- /.login-logo -->
